...
//GET
// http://localhost:3000/tareaPeticion/filtered?nombreTarea=algo
...
exports.crearTareaPeticion = async (req, res) => {
  const { Titulo, Descripcion, Fecha_estimada_cierre, enunciados, creatorId, imagen } = req.body;
...
exports.updateTareaPeticion = async (req, res) => {
  const { id } = req.params;
  const { Titulo, Descripcion, Fecha_estimada_cierre, imagen, enunciados } = req.body;
